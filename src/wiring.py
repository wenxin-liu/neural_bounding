...
def get_training_data(data, query, dimension, n_objects, n_samples=1):
    if query == 'point':
        # generate n_objects number of random points
        ...
        # generate n_objects number of random rays
        ...
        # generate n_objects number of random hyperplanes
        ...
        # generate n_objects number of random hypercubes
        features = get_boxes(n_dim=dimension, batch_size=n_objects).to(device)
